...
const BedStatus = () => {
  return (
    <DashboardLayout>
      ...
      {/* Side by side section starts here */}
            ...
            <div className="mt-6 pt-6 border-t border-gray-200">
              ...
              <div className="space-y-3">
                <div className="flex items-center text-sm">
                  <Badge className="bg-green-100 text-green-800 mr-2">+8</Badge>
                  <span className="text-medical-gray-600">New admissions</span>
                </div>
                <div className="flex items-center text-sm">
                  <Badge className="bg-blue-100 text-blue-800 mr-2">+5</Badge>
                  <span className="text-medical-gray-600">Transfers between departments</span>
                </div>
                <div className="flex items-center text-sm">
                  <Badge className="bg-orange-100 text-orange-800 mr-2">-12</Badge>
